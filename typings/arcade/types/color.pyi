...
"""
__all__ = ('Color', 'RGB', 'RGBA', 'RGB255', 'RGBA255', 'RGBNormalized', 'RGBANormalized', 'RGBOrA', 'RGBOrA255', 'RGBOrANormalized', 'MASK_RGBA_R', 'MASK_RGBA_G', 'MASK_RGBA_B', 'MASK_RGBA_A', 'MASK_RGB_R', 'MASK_RGB_G', 'MASK_RGB_B', 'MAX_UINT24', 'MAX_UINT32')
MAX_UINT24: Final[int] = ...
MAX_UINT32: Final[int] = ...
MASK_RGBA_R: Final[int] = ...
MASK_RGBA_G: Final[int] = ...
MASK_RGBA_B: Final[int] = ...
MASK_RGBA_A: Final[int] = ...
MASK_RGB_R: Final[int] = ...
MASK_RGB_G: Final[int] = ...
MASK_RGB_B: Final[int] = ...
...
class Color(RGBA255):
    ...
    * :py:meth:`.from_iterable`
    ...
    """
    __slots__ = ...
    def __new__(cls, r: int, g: int, b: int, a: int = ...): # -> Self:
        ...
    ...
    @classmethod
    def from_gray(cls, brightness: int, a: int = ...) -> Self:
    ...
    @classmethod
    def from_uint24(cls, color: int, a: int = ...) -> Self:
    ...
    @classmethod
    def random(cls, r: Optional[int] = ..., g: Optional[int] = ..., b: Optional[int] = ..., a: Optional[int] = ...) -> Self:
