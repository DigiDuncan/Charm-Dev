...
import ctypes
import weakref
from OpenGL._bytes import integer_types, long
...
class GLUStruct:
    ...
    """
    def getAsParam(self): # -> _Pointer[Any]:
    ...
    WRAPPER_METHODS = ...
    def noteObject(self, object): # -> int:
    ...
    def originalObject(self, voidPointer): # -> int | None:
