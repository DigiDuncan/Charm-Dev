...
.. versionadded:: 1.4
"""
def load(filename, file=..., decoder=..., batch=..., group=...):
...
class Material:
    __slots__ = ...
    def __init__(self, name: str = ..., diffuse: Tuple[float, float, float, float] = ..., ambient: Tuple[float, float, float, float] = ..., specular: Tuple[float, float, float, float] = ..., emission: Tuple[float, float, float, float] = ..., shininess: float = ..., texture_name: str = ...) -> None:
        ...
...
class Cube(Model):
    def __init__(self, width=..., height=..., depth=..., color=..., material=..., batch=..., group=..., program=...) -> None:
        ...
