...
known_cftypes = ...
def cftype_to_value(cftype): # -> int | float | str | None:
...
def cfset_to_set(cfset): # -> set[int | float | str | c_void_p | None]:
    """Convert CFSet to python set."""
    ...

def cfarray_to_list(cfarray): # -> list[int | float | str | c_void_p | None]:
