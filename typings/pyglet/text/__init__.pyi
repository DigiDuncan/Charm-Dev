...
def load(filename, file=..., mimetype=...): # -> FormattedDocument | UnformattedDocument:
...
def decode_html(text, location=...): # -> FormattedDocument | UnformattedDocument:
...
def decode_attributed(text): # -> FormattedDocument | UnformattedDocument:
...
def decode_text(text): # -> FormattedDocument | UnformattedDocument:
...
class DocumentLabel(layout.TextLayout):
    ...
    associated document.
    """
    def __init__(self, document=..., x=..., y=..., z=..., width=..., height=..., anchor_x=..., anchor_y=..., rotation=..., multiline=..., dpi=..., batch=..., group=..., program=..., init_document=...) -> None:
    ...
    def get_style(self, name): # -> Literal['indeterminate']:
...
class Label(DocumentLabel):
    """Plain text label."""
    def __init__(self, text=..., x=..., y=..., z=..., width=..., height=..., anchor_x=..., anchor_y=..., rotation=..., multiline=..., dpi=..., font_name=..., font_size=..., bold=..., italic=..., stretch=..., color=..., align=..., batch=..., group=..., program=...) -> None:
...
class HTMLLabel(DocumentLabel):
    ...
    details.
    """
    def __init__(self, text=..., x=..., y=..., z=..., width=..., height=..., anchor_x=..., anchor_y=..., rotation=..., multiline=..., dpi=..., location=..., batch=..., group=..., program=...) -> None:
