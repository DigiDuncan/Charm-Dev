...
class RunList:
    ...
    def __iter__(self): # -> Generator[tuple[Any | Literal[0], Any, Any], Any, None]:
        ...
...
class RunIterator(AbstractRunIterator):
    ...
    def ranges(self, start, end): # -> Generator[tuple[Any, Any, Any], Any, None]:
        ...
...
class OverriddenRunIterator(AbstractRunIterator):
    ...
    def ranges(self, start, end): # -> Generator[Any | tuple[Any, Any, Any], Any, None]:
        ...
...
class ZipRunIterator(AbstractRunIterator):
    ...
    def ranges(self, start, end): # -> Generator[tuple[Any, Any, list[Any]], Any, None]:
        ...
...
class ConstRunIterator(AbstractRunIterator):
    ...
    def __next__(self): # -> Generator[tuple[Literal[0], Any, Any], Any, None]:
        ...
