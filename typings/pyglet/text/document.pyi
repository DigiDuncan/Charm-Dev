...
class AbstractDocument(event.EventDispatcher):
    ...
    def insert_element(self, position: int, element: InlineElement, attributes: dict[str, Any] | None=...) -> None: # -> None:
...
class UnformattedDocument(AbstractDocument):
    ...
    def get_font(self, position=..., dpi=...): # -> GDIPlusFont | FreeTypeFont | QuartzFont | Win32DirectWriteFont:
        ...
...
class _FontStyleRunsRangeIterator:
    ...
    def ranges(self, start, end): # -> Generator[tuple[Any, Any, Any | GDIPlusFont | FreeTypeFont | QuartzFont | Win32DirectWriteFont], Any, None]:
        ...
    
    def __getitem__(self, index): # -> GDIPlusFont | FreeTypeFont | QuartzFont | Win32DirectWriteFont:
        ...
...
class _NoStyleRangeIterator:
    @staticmethod
    def ranges(start, end): # -> Generator[tuple[Any, Any, None], Any, None]:
        ...
