...
signature = ...
adam7 = ...
def adam7_generate(width, height): # -> Generator[Generator[tuple[Literal[0, 4, 2, 1], int, Literal[8, 4, 2, 1]], None, None], Any, None]:
    """
...
Resolution = ...
def group(s, n): # -> list[Any]:
    ...

def isarray(x): # -> bool:
    ...

def check_palette(palette): # -> list[Any] | None:
    """
...
def check_sizes(size, width, height): # -> tuple[Any, Any]:
    """
...
def check_color(c, greyscale, which): # -> tuple[Any]:
    """
...
class Writer:
    ...
    def array_scanlines(self, pixels): # -> Generator[Any, Any, None]:
        """
    ...
    def array_scanlines_interlace(self, pixels): # -> Generator[Any | array[Any], Any, None]:
        """
...
def rescale_rows(rows, rescale): # -> Generator[array[Any], Any, None]:
    """
...
def pack_rows(rows, bitdepth): # -> Generator[bytearray, Any, None]:
    """Yield packed rows that are a byte array.
    Each byte is packed with the values from several pixels.
    """
    ...

def unpack_rows(rows): # -> Generator[bytearray, Any, None]:
...
def check_bitdepth_rescale(palette, bitdepth, transparent, alpha, greyscale): # -> tuple[Any, None] | tuple[Literal[16, 4, 8], list[tuple[Any | Literal[3], Literal[16, 4, 8]]]] | tuple[Any | Literal[8, 16], None] | tuple[Any, list[tuple[Any, Any]]]:
    """
...
class Reader:
    ...
    def chunk(self, lenient=...): # -> tuple[Any, bytes | Any]:
        """
    ...
    def chunks(self): # -> Generator[tuple[Any, bytes | Any], Any, None]:
    ...
    def read(self, lenient=...): # -> tuple[Any, Any, Generator[array[int], Any, None] | Generator[bytearray | array[int], Any, None], dict[Any, Any]]:
        """
    ...
    def read_flat(self): # -> tuple[Any, Any, array[int], dict[Any, Any]]:
        """
    ...
    def palette(self, alpha=...): # -> list[Any]:
        """
    ...
    def asDirect(self): # -> tuple[Any, Any, Generator[array[int], Any, None] | Generator[bytearray | array[int], Any, None], dict[Any, Any]] | tuple[Any, Any, Generator[list[Any], Any, None] | Generator[array[int], Any, None] | Generator[array[Any], Any, None] | Generator[bytearray | array[int], Any, None], dict[Any, Any]]:
        """
    ...
    def asRGB8(self): # -> tuple[Any, Any, Any, Any] | tuple[Any, Any, Generator[list[int], Any, None], Any]:
        """
    ...
    def asRGBA8(self): # -> tuple[Any, Any, Any, Any] | tuple[Any, Any, Generator[list[int], Any, None], Any]:
        """
    ...
    def asRGB(self): # -> tuple[Any, Any, Generator[array[int], Any, None] | Generator[bytearray | array[int], Any, None] | Generator[list[Any], Any, None] | Generator[array[Any], Any, None], dict[Any, Any]] | tuple[Any, Any, Generator[Any, Any, None], dict[Any, Any]]:
        """
    ...
    def asRGBA(self): # -> tuple[Any, Any, Generator[array[int], Any, None] | Generator[bytearray | array[int], Any, None] | Generator[list[Any], Any, None] | Generator[array[Any], Any, None], dict[Any, Any]] | tuple[Any, Any, Generator[bytearray, Any, None], dict[Any, Any]]:
        """
...
def decompress(data_blocks): # -> Generator[bytearray, Any, None]:
    """
...
def binary_stdin(): # -> BinaryIO | Any:
    """
    A sys.stdin that returns bytes.
    """
    ...

def binary_stdout(): # -> BinaryIO | Any:
    """
    A sys.stdout that accepts bytes.
    """
    ...

def cli_open(path): # -> BinaryIO | Any | BufferedReader:
    ...
