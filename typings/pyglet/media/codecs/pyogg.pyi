...
if _debug:
    ...
if not (pyogg.PYOGG_OGG_AVAIL and not pyogg.PYOGG_VORBIS_AVAIL and not pyogg.PYOGG_VORBIS_FILE_AVAIL) and (not pyogg.PYOGG_OPUS_AVAIL and not pyogg.PYOGG_OPUS_FILE_AVAIL) and not pyogg.PYOGG_FLAC_AVAIL:
    ...
...
class PyOggDecoder(MediaDecoder):
    ...
    def decode(self, filename, file, streaming=...): # -> PyOggFLACSource | PyOggOpusSource | PyOggVorbisSource | StaticSource:
        ...
