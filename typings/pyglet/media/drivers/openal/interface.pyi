...
class OpenALContext(OpenALObject):
    ...
    def source_deleted(self, source): # -> None:
        ...
...
class OpenALBuffer(OpenALObject):
    _format_map = ...
    def __init__(self, al_name) -> None:
        ...
    ...
    def data(self, audio_data, audio_format): # -> None:
        ...
...
class OpenALBufferPool(OpenALObject):
    ...
    def get_buffers(self, number): # -> list[Any]:
    ...
    def return_buffers(self, buffers): # -> None:
