...
class FlatEnvelope(_Envelope):
    ...
    def get_generator(self, sample_rate, duration): # -> Generator[float, Any, NoReturn]:
        ...
...
class LinearDecayEnvelope(_Envelope):
    ...
    def get_generator(self, sample_rate, duration): # -> Generator[float | Literal[0], Any, NoReturn]:
        ...
...
def silence_generator(frequency, sample_rate): # -> Generator[Literal[0], Any, NoReturn]:
    ...

def noise_generator(frequency, sample_rate): # -> Generator[float, Any, NoReturn]:
    ...

def sine_generator(frequency, sample_rate): # -> Generator[float, Any, NoReturn]:
    ...

def triangle_generator(frequency, sample_rate): # -> Generator[Any | int, Any, NoReturn]:
    ...

def sawtooth_generator(frequency, sample_rate): # -> Generator[Any, Any, NoReturn]:
    ...

def pulse_generator(frequency, sample_rate, duty_cycle=...): # -> Generator[int, Any, NoReturn]:
    ...
...
def sine_operator(sample_rate=..., frequency=..., index=..., modulator=..., envelope=...): # -> Generator[float, Any, NoReturn]:
