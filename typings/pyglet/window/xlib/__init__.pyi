...
from pyglet.libs.x11 import cursorfont, xlib, xsync
...
class XlibWindow(BaseWindow):
    ...
    def get_single_property(self, window, atom_property, atom_type): # -> tuple[_Pointer[c_ubyte], int, int]:
        """ Returns the length, data, and actual atom of a window property. """
        ...
    
    @staticmethod
    def parse_filenames(decoded_string): # -> list[Any]:
