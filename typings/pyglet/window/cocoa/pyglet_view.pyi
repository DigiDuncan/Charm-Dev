...
NSNumber = ...
maskForKey = ...
def getMouseDelta(nsevent): # -> tuple[Any, Any]:
    ...
...
class PygletView_Implementation:
    ...
    def initWithFrame_cocoaWindow_(self, frame, window): # -> ObjCInstance | None:
        ...
    ...
    @PygletView.method('v@')
    def keyUp_(self, nsevent): # -> None:
        ...
    
    @PygletView.method('v@')
    def flagsChanged_(self, nsevent): # -> None:
        ...
    ...
    @PygletView.method('Q@')
    def draggingEntered_(self, draginfo): # -> int:
        ...
    
    @PygletView.method('B@')
    def performDragOperation_(self, sender): # -> None:
        ...
