...
def get_grapheme_clusters(text): # -> list[Any]:
...
class GlyphTextureBin(image.atlas.TextureBin):
    ...
    def add(self, img, fmt=..., min_filter=..., mag_filter=..., border=...): # -> TextureRegion:
        ...
...
class Font:
    ...
    def create_glyph(self, image, fmt=...): # -> TextureRegion:
    ...
    def get_glyphs_for_width(self, text, width): # -> list[Any]:
