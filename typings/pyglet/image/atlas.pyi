...
from pyglet.image import AbstractImage, TextureArrayRegion, TextureRegion
...
class TextureAtlas:
    ...
    def add(self, img: AbstractImage, border: int = ...) -> TextureRegion:
...
class TextureBin:
    ...
    """
    def __init__(self, texture_width: int = ..., texture_height: int = ...) -> None:
...
class TextureArrayBin:
    ...
    """
    def __init__(self, texture_width: int = ..., texture_height: int = ..., max_depth: Optional[int] = ...) -> None:
        ...
