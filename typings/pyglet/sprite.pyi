...
class Sprite(event.EventDispatcher):
    ...
    @property
    def position(self): # -> tuple[int | Any, int | Any, int | Any]:
    ...
    @property
    def color(self): # -> tuple[Literal[255], Literal[255], Literal[255], Literal[255]] | tuple[*tuple[Any | Literal[255], ...], Any] | tuple[Any, Any, Any, Any | Literal[255]]:
        """Blend color.
