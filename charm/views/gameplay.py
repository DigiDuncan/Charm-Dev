...
class GameView(DigiView):
    def __init__(self, song: Song, back: DigiView):
    ...
    @classmethod
    def random(cls, back: DigiView) -> GameView:
        random_song = choice(load_songs_fnf())
        return cls(FNFSong.parse(random_song.path), back)
